...
';
    ...
    public static function uni2zg($unicode)
    {
        ...
        return self::output_paoh_zawgyi(self::replaceWithRule($rule, self::input_paoh($unicode)));
    }
    ...
    public static function zg2uni($zawgyi)
    {
        ...
        return self::output_paoh_unicode(self::replaceWithRule($rule, self::input_paoh($zawgyi)));
    }
    ...
    //Mai Ngar => zMaiNgarz
    private static function input_paoh($output){
        $rule = json_decode("[{\"from\":\"\\u108F\",\"to\":\"zMaiPatNgarz\"},{\"from\":\"\\u109E\",\"to\":\"zMaiPatNgarz\"},{\"from\":\"\\u1052\",\"to\":\"zMaiPatNgarz\"},{\"from\":\"\\uAA7B\",\"to\":\"zMaiNgarz\"},{\"from\":\"\\u109F\",\"to\":\"zMaiNgarz\"},{\"from\":\"\\u1053\",\"to\":\"zMaiNgarz\"}]",true);
        return self::replaceWithRule($rule, $output);
    }

    //PaOh Zawgyi
    //zMaiPatNgarz => u1052
    //zMaiNgarz => u1053
    private static function output_paoh_zawgyi($output){
        $rule = json_decode("[{\"from\":\"zMaiPatNgarz\",\"to\":\"\\u1052\"},{\"from\":\"zMaiNgarz\",\"to\":\"\\u1053\"}]",true);
        return self::replaceWithRule($rule, $output);
    }
    ...
    //zMaiPatNgarz => u108F
    //zMaiNgarz => uAA7B
    private static function output_paoh_unicode($output){
        $rule = json_decode("[{\"from\":\"zMaiPatNgarz\",\"to\":\"\\u108F\"},{\"from\":\"zMaiNgarz\",\"to\":\"\\uAA7B\"}]",true);
        return self::replaceWithRule($rule, $output);
    }
