...
public class Rabbit {
  ...
  public static String uni2zg(String input) {
      ...
      return output_paoh_zawgyi(replace_with_rule(rule,input_paoh(input)));
  }
    ...
    public static String zg2uni(String input) {
        ...
        return output_paoh_unicode(replace_with_rule(rule,input_paoh(input)));
    ...
    //Mai Ngar => zMaiNgarz
    private static String input_paoh(String output){
        String rule = "[{\"from\":\"\\u108F\",\"to\":\"zMaiPatNgarz\"},{\"from\":\"\\u109E\",\"to\":\"zMaiPatNgarz\"},{\"from\":\"\\u1052\",\"to\":\"zMaiPatNgarz\"},{\"from\":\"\\uAA7B\",\"to\":\"zMaiNgarz\"},{\"from\":\"\\u109F\",\"to\":\"zMaiNgarz\"},{\"from\":\"\\u1053\",\"to\":\"zMaiNgarz\"}]";
